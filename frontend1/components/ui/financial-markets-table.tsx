...
const defaultIndices: MarketIndex[] = [
  {
    id: "1",
    name: "0xA3F...9K2 (High Risk Wallet)",
    country: "Ethereum",
    countryCode: "US",
    ytdReturn: 82.4, // risk score %
    pltmEps: 124.32, // suspicious tx count
    divYield: 67.3, // fraud probability %
    marketCap: 1.82, // total funds moved (B)
    volume: 4.6, // tx volume (M)
    chartData: [42, 48, 55, 63, 71, 75, 80, 84, 82, 88],
    price: 12.7, // avg ETH value moved
    dailyChange: 6.2,
    dailyChangePercent: 14.8
  },
  {
    id: "2",
    name: "Binance Cluster Node",
    country: "Global",
    countryCode: "CA",
    ytdReturn: 21.5,
    pltmEps: 19.4,
    ...
    marketCap: 12.4,
    volume: 38.2,
    chartData: [20, 21, 22, 20, 19, 23, 24, 25, 24, 26],
    price: 3.9,
    dailyChange: -1.2,
  ...
  {
    id: "3",
    name: "Tornado Cash Linked Wallet",
    country: "Ethereum",
    countryCode: "US",
    ytdReturn: 91.2,
    pltmEps: 208.5,
    ...
    marketCap: 4.3,
    volume: 9.7,
    chartData: [60, 64, 70, 76, 80, 85, 89, 92, 95, 98],
    price: 18.4,
    dailyChange: 9.7,
    dailyChangePercent: 21.3
  },
  {
    id: "4",
    name: "DeFi Bridge Exploit Cluster",
    country: "Multi-Chain",
    countryCode: "MX",
    ytdReturn: 74.8,
    pltmEps: 145.7,
    ...
    marketCap: 6.9,
    volume: 12.1,
    chartData: [40, 42, 44, 49, 53, 57, 61, 66, 70, 74],
    price: 10.3,
    dailyChange: 4.2,
    dailyChangePercent: 11.8
  },
  {
    id: "5",
    name: "Phishing Attack Network",
    country: "Global",
    countryCode: "BR",
    ytdReturn: 66.1,
    pltmEps: 302.8,
    ...
    marketCap: 2.7,
    volume: 15.4,
    chartData: [28, 30, 35, 39, 44, 48, 52, 55, 60, 66],
    price: 6.1,
    dailyChange: 7.8,
    dailyChangePercent: 19.5
  },
  {
    id: "6",
    name: "Clean Institutional Wallet",
    country: "USA",
    countryCode: "US",
    ytdReturn: 4.2,
    pltmEps: 3.1,
    ...
    marketCap: 9.4,
    volume: 22.6,
    chartData: [4, 4.1, 4.0, 4.3, 4.1, 4.2, 4.1, 4.0, 4.2, 4.3],
    price: 2.4,
    dailyChange: -0.2,
